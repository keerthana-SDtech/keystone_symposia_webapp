...
import { Loader2, FileText, UserRound, Mail } from "lucide-react";
...
import { SubmissionSuccessCard } from "../features/form-submission/components/SubmissionSuccessCard";
            ...
            <PageShell className="relative pb-24 bg-[#FAFBFD] min-h-screen flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-10 w-full max-w-2xl px-6 pt-16">
                    <SubmissionSuccessCard
                        title="Concept Successfully Submitted !"
                        subtitle="Thank you for submitting your conference concept"
                    >
